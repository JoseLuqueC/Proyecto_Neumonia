...
# --- PARCHE PARA PYTHON 3.13 (Compatibilidad tkcap) ---
import tkinter
sys.modules['tkinter.tix'] = tkinter 
# --------------------------------------------------------

# Regla de Rúbrica: Eliminar explícitamente los warnings (no solo ocultarlos en consola)
...
# Importaciones modulares de la nueva arquitectura
...
class App:
    ...
    def load_img_file(self):
        ...
        if filepath:
            ...
            # Compatible con las nuevas versiones de Pillow (v10+)
